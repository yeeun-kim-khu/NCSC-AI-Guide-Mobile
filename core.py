...
대표번호는 모두 동일해요: **02-3668-3350**"""
        ...
        if category == "exhibit_guide":
            if mode == "어린이":
                return f"""🎨 전시관(놀이터) 소개예요!

국립어린이과학관에는 **1층과 2층에 총 6개의 놀이터 + 천체투영관 + 과학극장**이 있어요. 각 공간은 주제와 추천 연령이 달라요.
...
#### 💡 관람 팁
- **입구는 2층, 출구는 1층**이에요. **2층 → 1층** 순서로 보면 좋아요.
- 점심·간식은 2층 **휴게실**에서 드세요.
- 천체투영관·과학쇼 시간을 먼저 정해두고 전시 관람 사이에 끼워넣는 게 좋아요.

💬 특정 놀이터가 궁금하면 **"AI놀이터 전시물 뭐 있어?"** 처럼 말해주세요!"""
            else:
                return f"""🎨 전시관(놀이터) 소개
