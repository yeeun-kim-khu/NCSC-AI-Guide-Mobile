...
def route_intent(text: str) -> str:
    ...
    흐름:
    1) 명확한 특수 케이스 즉시 처리 (길찾기 2단계, 공지, 날짜 운영, 나이)
    2) 명확한 FAQ 키워드 → basic (즉시, 룰베이스)
    3) 프로그램명 + FAQ 의도 신호 → basic (즉시, 룰베이스)
    4) 애매한 케이스 → classify_intent_with_llm (0.3~0.5초, gpt-4o-mini)
    """
