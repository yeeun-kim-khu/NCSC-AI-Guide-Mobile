...
def classify_basic_category(message: str) -> str:
    ...
    rules = [
        # 가장 구체적인 카테고리 먼저
        ("education_guide", ["교육 프로그램", "교육프로그램", "교육과정", "교육 과정", "과학교실", "수학교실", "sw공학교실", "ai공학교실", "유아특화교실", "방학과정", "나눔과정", "창경궁 프로그램", "창경궁프로그램", "창경궁 교육", "창경궁교육", "빛놀이터 교육", "빛놀이터교육", "전시연계 교육", "전시연계교육", "어린이 맞춤 과학", "어린이맞춤과학", "프로그램"]),
...
**천체투영관**
- 코코몽 우주여행, 키츠의 별나라, 바니의 태양계, 다이노소어 등 매일 상영
