...
**반드시 추천 — 당일 현장 참여 가능한 활동:**
1. **상설전시관 관람**: 탐구놀이터, 관찰놀이터, 행동놀이터, 생각놀이터, AI놀이터 (입장권으로 자유 관람)
2. **과학쇼 (사이언스랩 / 로봇쇼)**: 1층 과학극장, 당일 현장 참여 가능, 운영 시간 별도 확인
3. **전시해설**: 전시관 내 전시해설사 해설 프로그램, 당일 현장 참여 가능

**별도 예약 안내 필요 — 빛놀이터 & 천체투영관:**
- **빛놀이터** (2층): 사전예약제로 운영됩니다. 예약 현황은 입구 또는 매표소에서 확인하세요.
- **천체투영관** (1층): 사전예약제로 운영됩니다. 당일 잔여석 여부는 매표소에서 확인하세요.
- 위 두 곳은 "당일 현장 참여 가능할 수도 있으니 매표소에서 잔여 좌석을 확인해보세요"라고 안내하세요.
